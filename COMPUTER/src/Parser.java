...
public class Parser {
    ...
    public int convertAssemblyToBinary(String instruction) {
        ...
        if (instType == 0) {
            ...
            binaryInstruction += firstNBits(opCode, 4); //btrg3 el right most 4 bits 
            //TERM 1 AND TERM 2 
            for (int i = 1; i <= 2; i++) {
            ...
            int r1 = Integer.parseInt(term[1].substring(1)); //MAFIISH FOR LOOP 3ASHAN MSH KOL HAGAT FEHA R2 
        ...
        return Instruction.parseSignedInteger(binaryInstruction);  // BINARY BYBD2 B 1 HAYBWZ EL RAKM 
        //INTEGER.PASRSEINT BYTL3 EXCEPTION 
    }
